...
//	@Test
	public void StringApi(){
		...
		print("修改key001："+redis.set("key001", "key-update")+" "+redis.get("key001"));
		print("最后追加字符串："+redis.append("key001", "-append")+" "+redis.get("key001"));
		print("删除key001："+redis.del("key001"));
		
		print("==================多个一起添加,删除==================");
		print("增减key021，key022，key023："+redis.mset("key021","key021value","key022","key022value","key023","key023value"));
...
//	@Test
	public void HashApi(){
		...
		print("=============修改====================");
		print("修改key001值为value001_update:"+redis.hset("hashs", "key001", "value001_update"));
